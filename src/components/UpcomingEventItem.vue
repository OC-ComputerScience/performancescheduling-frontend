...
function generatePDF() {
  ...
  doc.setFontSize(16).text("Event: " + props.eventData.name, 1.5, 1.0);
  doc
    .setFontSize(12)
    .text("Date: " + formatDate(props.eventData.date), 1.5, 1.3);
  doc
    .setFontSize(12)
    .text(
      "Time: " +
        get12HourTimeStringFromString(props.eventData.startTime) +
        " - " +
        get12HourTimeStringFromString(props.eventData.endTime),
      1.5,
      1.6
    );
  ...
  doc
    .setFontSize(12)
    .text("Location: " + props.eventData.location.roomName, 1.5, 1.9);
