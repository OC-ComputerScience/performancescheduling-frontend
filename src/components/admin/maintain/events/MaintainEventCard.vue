...
//import font from "../../../../fonts/helvetica-normal.js";
      ...
      if (eventSignup.studentInstrumentSignups.length > 0) {
        eventSignup.studentInstrumentSignups.forEach(function (
          ...
          signup.students.push({
            ...
            major: studentInstrument.studentInstrument.studentRole.major.name,
...
*/
  ...
  doc
    .setFontSize(18)
    .setFont("helvetica", "bold")
    .text(props.eventData.name, 4.25, 3.2, { align: "center" });
  ...
  pdfSignups.forEach(function (signup) {
    ...
    signup.students.forEach(function (student) {
      ...
      doc
        ...
        .setFont("helvetica", "normal")
        .text(
          student.classification + " " + student.major + " major",
          4.25,
          line,
          { align: "center" }
        );
