...
async generateProgram(eventData,) {
    const studentSignupData = ref([]);
    await EventDataService.getById(eventData.id)
      .then((response) => {
    ...
    studentSignupData.value.eventSignups.forEach(function (eventSignup) {
      if (!eventData.eventType.allowGrade || eventSignup.pass) {
        ...
        signup.pieces = [];
        eventSignup.eventSignupPieces.forEach(function (eventSignupPieces) {
          let progPiece = {};
          progPiece.title = eventSignupPieces.piece.title;
          progPiece.composer =
            eventSignupPieces.piece.composer.firstName +
            " " +
        ...
        if (eventSignup.studentInstrumentSignups.length > 0) {
          eventSignup.studentInstrumentSignups.forEach(function (
            ...
            signup.students.push({
              ...
              classification:
                studentInstrument.studentInstrument.studentRole
                  .studentClassification != undefined
                  ? studentInstrument.studentInstrument.studentRole
              ...
              instructor:
                (studentInstrument.studentInstrument.instructorRole.user.honorific
                  ? studentInstrument.studentInstrument.instructorRole.user
                      .honorific+" "
                  : "") +
                studentInstrument.studentInstrument.instructorRole.user
                  .firstName +
                " " +
                studentInstrument.studentInstrument.instructorRole.user.lastName,
              accompanist:
                (studentInstrument.studentInstrument.accompanistRole
                  ? studentInstrument.studentInstrument.accompanistRole.user
                      .firstName
                  : "") +
                " " +
                (studentInstrument.studentInstrument.accompanistRole
  ...
  */
    ...
    doc
      ...
      .text("Oklahoma Christian University", 4.25, 1.0, { align: "center" });
    doc
      .setFontSize(16)
      .text("College of Liberal Arts", 4.25, 1.4, { align: "center" });
    doc
      .setFontSize(18)
    ...
    let name = eventData.programName != null ? eventData.programName : eventData.name ;
    doc
      .setFontSize(18)
      .setFont("helvetica", "bold")
      .text(name, 4.25, 3.2, { align: "center" });
  ...
  */
    ...
    pdfSignups.forEach(function (signup) {
      ...
      signup.students.forEach(function (student) {
        ...
        line += lineSize;
        comma = student.classification != null ? ", " : "";
        doc
          .setFontSize(10)
          .setFont("helvetica", "normal")
          .text(
            student.classification + comma + student.major + " Major",
            4.25,
            line,
            { align: "center" }
          );
        ...
        doc.setFontSize(10).text("Student of " + student.instructor, 4.25, line, {
          align: "center",
        });
        line += lineSize;
